...
//! Taken from the [`chunked_transfer`](https://crates.io/crates/chunked_transfer) crate.
//! I filed a PR on their github but I will have to use my own version until it is resolved.
